...
description = "JDesk security-probe test application (spec 17.6; real native runs only; no fake providers)."
dependencies {
...
application {
    mainModule = "dev.jdesk.testapps.securityprobe"
    mainClass = "dev.jdesk.testapps.securityprobe.Main"
}
...
tasks.named<JavaExec>("run") {
    ...
    systemProperty("jdesk.evidence.category",
        providers.gradleProperty("jdeskEvidenceCategory").getOrElse("native"))
